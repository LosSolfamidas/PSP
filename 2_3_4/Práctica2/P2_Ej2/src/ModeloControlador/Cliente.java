    ...
    public void recibirFichero(String nombreFichero) {
        ...
        try {
            ...
            if (!o_i_s.readBoolean()) {//si NO existe ese fichero devuelve un 0.
                ...
                BufferedOutputStream buffOutFichero = new BufferedOutputStream(new FileOutputStream(new File(directorioFicheros, nombreFichero)));
                ...
                while ((numBytesLeidos = o_i_s.read(buffer)) > 0) {
                    buffOutFichero.write(buffer, 0, numBytesLeidos);
                }
                buffOutFichero.close();
