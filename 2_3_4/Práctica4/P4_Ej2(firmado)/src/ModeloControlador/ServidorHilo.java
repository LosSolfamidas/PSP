...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
            // Se elige una clave simetrica para la transaccion:
            simetricKey = getSimetricKey(16);
            System.out.println("SERVIDOR: " + simetricKey);

            // Se firma y cifra:
            t = new Tiempo();    // Mido el tiempo que se tarda en cirar
            ...
            t.fin();    // Fin del cifrado
            
            System.out.println("Se ha tardado " + t.getTiempo() + "ms en cifrar los datos");
            // Se envia la clave:
