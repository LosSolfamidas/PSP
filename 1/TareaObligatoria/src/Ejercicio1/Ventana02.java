 ...
 * @author LYNCHANIANO
 */
public class Ventana02 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Ventana02(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setModal(false);
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Ventana02 dialog = new Ventana02(new javax.swing.JFrame(), true);
